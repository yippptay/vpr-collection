(function(e) {
  ...
  function initHeaderSticky() {
    if (jQuery(document).height() > jQuery(window).height()) {
      if (jQuery(window).width() >= 1200) {
        if (jQuery('.header_1 .main-header').hasClass("sticky_header")) {
          if (jQuery(this).scrollTop() > 400) {            
            jQuery('.header_1 .main-header').addClass("fixed");
            jQuery(".ttresponsive_menu").insertAfter(".header_logo_wrap");
          } else {           
            jQuery('.header_1 .main-header').removeClass("fixed");
            jQuery(".header_1 .ttresponsive_menu").insertBefore(".header_1 .tthorizontal_menu");
          }
        } else {
          jQuery('.header_1 .main-header').removeClass("fixed");
          jQuery(".header_1 .ttresponsive_menu").insertBefore(".header_1 .tthorizontal_menu");
  ...
  var t = {
    ...
    producteffect: function() {
      $('.product-wrapper.product_container.hover_imgs').on('mouseover', function() {
    ...
    initProductMoreview: function() {
      ...
      e('body .announce-banner .announce-banner-content .announce-content').slick({   
        slidesToShow: 2,
        arrows: false,
        autoplay: true,
        autoplaySpeed: 0,
      ...
      e('body .brands_slider_wrap .tt-brand_slider').slick({   
        slidesToShow: 6,
        arrows: false,
        autoplay: true,
        autoplaySpeed: 0,
    ...
    initDropDownCart: function() {
      ...
      e("body:not(.template-cart) .site-header_cart_link").on('click',function(event) {
        event.preventDefault();
      ...
      e("body:not(.template-cart) .fixed-cart-wrap ,body:not(.template-cart) .cart-close").on('click',function(event) {
    ...
    closeDropdownCart: function() {
      if (e(".site-header #Sticky-slidedown-cart").is(":visible")) {
        e(".site-header #Sticky-slidedown-cart").slideUp("fast")
      }
    },
  ...
  e(".quick-view-text").click(function() {
    ...
    Shopify.getProduct(product, function(product) {
      ...
      if (!product.available) {
        ...
        i.find(".add-to-cart-btn").text("Sold Out").addClass("disabled").attr("disabled", "disabled");
        var C = jQuery(".quick-view .product-shop .product-item").attr("data-id");          
        jQuery("#product-actions-" + C).find(".actions .add-to-cart-btn").prepend( jQuery("<i class='mdi mdi-plus'></i>"));
      } else {
  ...
  e(".quick-view .overlay, .close-window").on("click", function() {
    ...
    doUpdateDropdownCart: function(n) {
      ...
      e("#slidedown-cart .summary .price,.site-header__cart-count .price").html(Shopify.formatMoney(n.total_price, window.money_format));
      ...
      if (n.item_count > 0) {
        ...
        if (t.checkNeedToConvertCurrency()) {
          Currency.convertAll(window.shop_currency, jQuery('.currencies li.active .currencies-a').val(), '#slidedown-cart span.money,.site-header__cart-count span.money', 'money_format');
    ...
    sidebarMapView: function() {
      ...
      jQuery('#list-view').on('click',function() {
        ...
        jQuery('.products-grid-view > div.grid-item').each(function(){                      
          ...
          var clr_size = jQuery(this).find('.product-description .spr-badges.grid-item-meta');
          jQuery(this).find('.color-size').insertAfter(clr_size);   
        });
      ...
      jQuery('#grid-view').on('click', function() {
        ...
        jQuery('.products-grid-view > div.product-grid').each(function() {
          var prod_ven_unwrap = jQuery(this).find('.product-wrapper .product-description .short-title');
          jQuery(prod_ven_unwrap).children().unwrap()
          var clr_size = jQuery(this).find('.product-wrapper .product-description');
          jQuery(this).find('.color-size').prependTo(clr_size);
        });
        ...
        jQuery('.products-grid-view > div.grid-item.style1').each(function() {
          ...
          var prod_desc = jQuery(this).find('.product-description');
          jQuery(this).find('.cart-qty').appendTo(prod_desc);
        ...
        jQuery('.products-grid-view > div.grid-item.style3').each(function() {
          ...
          var prod_desc = jQuery(this).find('.grid-view-item__meta');
          jQuery(this).find('.cart-qty').insertAfter(prod_desc);
          var clr_size = jQuery(this).find('.product-thumb');
          jQuery(this).find('.color-size').appendTo(clr_size);
        });
